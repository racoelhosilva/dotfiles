...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,		  }, "v", function () awful.spawn("code") end,
    	      {description = "open VSCode Editor", group = "launcher"}),
    ...
    awful.key({ modkey,		  }, "a", function () awful.spawn("rofi -show window") end,
              {description = "open rofi in window mode", group = "launcher"}),
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.spawn("dmenu_run -fn 'FiraCode Nerd Font Mono-16' -sb orange -sf white") end,
